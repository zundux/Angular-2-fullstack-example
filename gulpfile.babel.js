// Generated on 2017-04-26 using generator-angular-fullstack 5.0.0-alpha.4
'use strict';
...
let lintClientScripts = lazypipe()
  // .pipe(tslint({
  //   configuration: require(`./${clientPath}/tslint.json`),
  //   formatter: "prose" //or "verbose"
  // }))
  // .pipe(tslint.report({
  //   emitError: false
...
gulp.task('lint:scripts:client', () => {
  return gulp.src(_.union(
    ...
    .pipe(gulpIgnore.exclude(excludedFiles))
...
// todo maybe remove because jscs has heirs such as eslint and tslint
gulp.task('jscs', () => {
  return gulp.src(_.union(
    paths.client.scripts,
    paths.server.scripts,
